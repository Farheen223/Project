...
<body style="height: 461px">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtDateAdded" runat="server" OnTextChanged="txtSupplyDate_TextChanged" style="z-index: 1; left: 122px; top: 167px; position: absolute; width: 119px"></asp:TextBox>
        <p>
            &nbsp;</p>
